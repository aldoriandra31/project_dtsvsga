...
<body>
    ...
    <main>
        ...
        <div class="tambah-wrapper">
            <a class="btn-tambah"href="<?= BASE_PATH . 'dashboard/admin/tambah.php' ?>" >+ Tambah</a>
        </div>
        ...
        <tbody id="table-body">
            ...
            <tr>
                ...
                <td><?= $user["email"]; ?></td>
                <td class="btn-action">
                    <a href="<?= BASE_PATH . "dashboard/admin/edit.php?id=" . $user["id"]; ?>" class="btn-edit">edit</a>
                    <form action="<?= BASE_PATH . "dashboard/admin/delete.php" ?>" method="get" onsubmit="return confirm('apakah anda yakin menghapus data?')">
